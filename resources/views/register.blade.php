            ...
            <form method="POST" action="{{route('validar-registro')}}">
                ...
                <section>
                    <div class="input-group">
                        <input class="input" autocomplete="off" name="nombres" type="text" required="">
                ...
                <section>
                    <div class="input-group">
                        <input class="input" autocomplete="off" name="apellidos" type="text" required="">
